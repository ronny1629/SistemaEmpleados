...
namespace BackEndApi.DTOs.Models;
...
public partial class DbempleadoContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDepartamento).HasName("PK__Departam__787A433D5E23BDD6");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__CE6D8B9E7C39FF19");
